...
  
        function InPutCheckIn(Rno,Rtype,Rprice){
			if(Rtype=="单人间"){
				...
				open ('/SJK/Page/CheckInPut/CheckInInPut2.jsp?Rno='+Rno+'&Rprice='+Rprice, '客户信息登记' , 'height=750, width=700, top=300, left=500,  toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no') //这句要写成一行
			}else if(Rtype=="单人钟点房"){
				...
				open ('/SJK/Page/CheckInPut/CheckInInPut4.jsp?Rno='+Rno+'&Rprice='+Rprice, '客户信息登记' , 'height=750, width=700, top=300, left=500,  toolbar=no, menubar=no, scrollbars=no, resizable=no,location=n o, status=no') //这句要写成一行
			}
     	   }
    </script>
